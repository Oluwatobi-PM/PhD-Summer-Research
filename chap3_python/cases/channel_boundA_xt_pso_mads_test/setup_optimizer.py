"""Chapter 3 channelmodel PSO-MADS hybrid setup.

MADS is called from the current PSO best particle. It continues through
one-iteration NOMAD episodes while it improves and returns to PSO after the
first non-improving episode, reducing the MADS frame size for the next call.
"""
...
HYBRID_OPTIONS = {
    ...
    "PSO_STALL_ITERATIONS": 3,
    "GLOBAL_ITERATIONS_PER_CYCLE": 2,
    "LOCAL_MADS_BUDGET": 32,
