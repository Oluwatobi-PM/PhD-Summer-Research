"""Load case-level NOMAD/MADS setup files."""
...
def config_from_setup(path: str | Path) -> CaseConfig:
    """Build `CaseConfig` from a NOMAD/MADS setup file."""
    ...
    max_evals = getattr(module, "MAX_SIMULATIONS", getattr(module, "MAX_BB_EVAL", None))
    if max_evals is None:
        raise AttributeError("MADS setup requires MAX_SIMULATIONS or MAX_BB_EVAL.")
